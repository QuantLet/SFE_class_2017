%%This code is based on: Chen YHC, H?rdle WK, Hou AJ, Wang W (2018)
%Pricing Cryptocurrency options: 
%the case of CRIX and Bitcoin. J Financial Econometrics, submitted
%(ISSN: 2568-5619) 20018-004
%This code contains the MCMC for the parameters of 
%Stochastic Volatilty with Correlated Jumps

%By getting the results of the parameters, one can use them 
%in the R code: SEFCrixSimu, for a simulation of SVCJ

%to run this code one has to use CrixData.mat, and also the
%code normt_rnd.m
